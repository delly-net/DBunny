...
1. 更新 `Delly.DBunny.Linq.csproj` 的 TargetFrameworks 为 `netstandard2.0;net6.0;net8.0`
2. 添加项目引用到 `Delly.DBunny.Core`
3. 添加 `Delly.Modeling` 包引用：
```xml
<ItemGroup>
...
namespace Delly.DBunny.Linq.Dependency
{
    ...
    public interface IQueryExpressionRelay
    {
        ...
        static IQueryExpressionRelay Create(
            Delly.Modeling.IEntityModelFactory entityModelFactory,
...
- **Delly.Modeling**：提供 `IEntityModel` 和 `IEntityModelFactory` 接口，版本 2026.5.18
- 该包已在 `Delly.DBunny.Core` 中引用，确保版本一致性
